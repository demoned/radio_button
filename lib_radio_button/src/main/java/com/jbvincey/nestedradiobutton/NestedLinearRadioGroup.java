...
public class NestedLinearRadioGroup extends LinearLayoutCompat implements NestedRadioGroupInterface {
    private static final String LOG_TAG = NestedLinearRadioGroup.class.getSimpleName();

    @NonNull
    private NestedRadioGroupManager nestedRadioGroupManager;

    public NestedLinearRadioGroup(@NonNull Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public NestedLinearRadioGroup(@NonNull Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
        init();
        initAttrs(context, attrs);
    }

    public NestedLinearRadioGroup(@NonNull Context context, @NonNull AttributeSet attrs, int defStyleAttr) {
     ...
     */
    @Override
    public NestedLinearRadioGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new NestedLinearRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof NestedLinearRadioGroup.LayoutParams;
    }

    @Override
    protected NestedLinearRadioGroup.LayoutParams generateDefaultLayoutParams() {
        return new NestedLinearRadioGroup.LayoutParams(RadioGroup.LayoutParams.WRAP_CONTENT, RadioGroup.LayoutParams.WRAP_CONTENT);
    }
